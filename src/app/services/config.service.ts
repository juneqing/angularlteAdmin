...
import { Http, RequestOptionsArgs, Jsonp } from '@angular/http';
...
export class ConfigService {
  ...
  * 
  ...
  constructor(public router: Router, public route: ActivatedRoute, public http: Http, public jsonp: Jsonp) { }
